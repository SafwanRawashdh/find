...
export default function RegisterPage() {
    ...
    const onSubmit = async (data: RegisterFormData) => {
        ...
        try {
            ...
            router.push("/auth/after-register");
        } catch (error) {
            setServerError(
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-4 py-3 rounded-lg bg-dark-700/50 border text-white placeholder:text-dark-400 focus:outline-none transition-colors ${errors.name
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-4 py-3 rounded-lg bg-dark-700/50 border text-white placeholder:text-dark-400 focus:outline-none transition-colors ${errors.email
                                        ? "border-red-500/50 focus:border-red-500/50"
                                        : "border-dark-600/50 focus:border-accent-purple/50"
                                        }`}
                                />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    {...register("password")}
                                    placeholder="••••••••"
                                    className={`w-full pl-11 pr-12 py-3 rounded-lg bg-dark-700/50 border text-white placeholder:text-dark-400 focus:outline-none transition-colors ${errors.password
                                        ? "border-red-500/50 focus:border-red-500/50"
                                        : "border-dark-600/50 focus:border-accent-purple/50"
                                        }`}
                                />
