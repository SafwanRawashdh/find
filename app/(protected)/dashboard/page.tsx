...
function DashboardContent() {
    ...
    return (
        <>
            ...
            {status === "authenticated" && !hasSearched && (
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                    <div className="glass rounded-2xl p-6 mb-6 border border-accent-purple/20">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-dark-400 text-sm">
                                        You have access to all advanced filters and features.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-accent-lime/10 text-accent-lime text-sm font-medium">
                ...
                <div className="relative">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div className="flex flex-col lg:flex-row gap-8">
                            {/* Sidebar Filters - All unlocked for authenticated users */}
