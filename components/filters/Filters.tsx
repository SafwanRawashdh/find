...
const Filters: React.FC<FiltersProps> = ({ filters, setFilters }) => {
  ...
  const selectClass = "w-full text-sm bg-dark-600 border-dark-500 rounded-lg py-2.5 px-3 text-white border focus:border-accent-purple focus:ring-1 focus:ring-accent-purple transition-colors";
  const inputClass = "w-full text-sm bg-dark-600 border-dark-500 rounded-lg py-2 px-3 text-white border focus:border-accent-purple focus:ring-1 focus:ring-accent-purple transition-colors";
      ...
      <div className="w-full flex-shrink-0 space-y-6 pb-10">
        ...
        <div className="glass rounded-xl p-5 space-y-5">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-6 bg-gradient-to-b from-accent-purple to-accent-pink rounded-full"></div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-3 p-3 bg-dark-600/50 rounded-lg cursor-pointer hover:bg-dark-600 transition-colors group">
                ...
                />
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-amazon rounded-full"></span>
                  <span className="text-sm text-gray-300 group-hover:text-white transition-colors">Amazon</span>
                </div>
              </label>
              <label className="flex items-center gap-3 p-3 bg-dark-600/50 rounded-lg cursor-pointer hover:bg-dark-600 transition-colors group">
                <input 
                ...
                />
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-ebay rounded-full"></span>
                  <span className="text-sm text-gray-300 group-hover:text-white transition-colors">eBay</span>
                </div>
              </label>
            </div>
          </div>
        ...
        <div className="relative glass rounded-xl p-5 space-y-5">
          ...
          <div className={!isLoggedIn ? 'opacity-30 pointer-events-none select-none' : ''}>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-6 bg-gradient-to-b from-accent-cyan to-accent-lime rounded-full"></div>
