        ...
        <div className="relative transform overflow-hidden rounded-2xl glass text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-4xl animate-scale-in">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 bg-dark-700/50 p-8 flex flex-col items-center justify-center">
              {imageError ? (
                <div className="w-full h-[280px] flex items-center justify-center bg-dark-700 rounded-lg">
            ...
            <div className="md:w-1/2 p-8 flex flex-col">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span
                  className={`inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold capitalize ${
              ...
              <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                {product.description ||
                  "No description available for this product. Check the marketplace for more details."}
              </p>
              ...
              <div className="mt-auto space-y-3">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className={`flex-1 py-3 px-4 rounded-xl text-white font-bold shadow-lg transition-all text-center flex items-center justify-center gap-2 ${
                      isAmazon
