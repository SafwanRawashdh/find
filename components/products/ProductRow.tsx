...
const ProductRow: React.FC<ProductRowProps> = ({ title, items, colorClass, marketplace, onViewDetails }) => {
  ...
  const marketplaceIcon = marketplace === 'amazon' ? (
    ...
    <div className="mb-8 animate-fade-in">
      ...
      {items.length === 0 ? (
        ...
        <div className="relative group">
          ...
          {/* Gradient Fades */}
          <div className="absolute left-0 top-0 bottom-4 w-8 bg-gradient-to-r from-dark-900 to-transparent pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-4 w-8 bg-gradient-to-l from-dark-900 to-transparent pointer-events-none"></div>
        </div>
      )}
    </div>
  );
