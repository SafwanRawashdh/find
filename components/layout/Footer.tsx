      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold gradient-text">FIND</span>
            </Link>
            <p className="text-gray-400 text-sm mb-4">
              Compare prices across Amazon, eBay, and more. Never miss a deal.
            </p>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} FIND. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
            Prices and availability subject to change. Not affiliated with Amazon or eBay.
          </p>
        </div>
      </div>
    </footer>
